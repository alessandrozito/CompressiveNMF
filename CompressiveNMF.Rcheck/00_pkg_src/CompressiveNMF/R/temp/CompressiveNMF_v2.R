...
#'     # Check that the dimension of the prior is the same as the rows in the matrix
#'     if(nrow(cosmic_data) == I){
#'       S <- as.matrix(cosmic_data[, -c(1,2,3)])
#'     } else {
#'       stop("The matrix X has to have I = 96 rows.")
#'     }
#'   }
#'
...
#'     Run_mcmc_CompressiveNMF(X, model_pars, init_pars, nsamples, burnin, verbose.out = verbose.out, nchains = nchains)
#'   }
#'
#'
